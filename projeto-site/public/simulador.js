function calcular() {
    ...
    var num_totens = qtd_entradas.value ;


    if (num_funcionarios <= limite_totem) {
        num_totens = qtd_entradas.value ; //Se o número de funcionarios for maior igual  50 num_totens = 1
        ...
        num_totens = qtd_entradas.value ;
        document.getElementById('num_totens').value = num_totens;
    }

    var investimento_inicial = (num_totens * taxa_instalacao) + valor_servico;//(num_totens * 500) + 3500
    ...
    var lucro = investimento_inicial * 1.25; 
